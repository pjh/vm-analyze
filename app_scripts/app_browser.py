...
# listed in this file.
#browser_urls = "{}/app_browser_urls_30.txt".format(scripts_dir)
#browser_urls = "{}/app_browser_urls.txt".format(scripts_dir)
#browser_urls = "{}/app_browser_urls_alexa.txt".format(scripts_dir)
browser_urls = "{}/app_browser_urls_vmstudy.txt".format(scripts_dir)
